...
namespace OnSale.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Juan", "Monsalve", "jpmonsalverios.12@gmail.com", "14782548", "Copacabana", UserType.Admin);
        ...
        private async Task CheckProductsAsync()
        {
            ...
            {
                User user = await _userHelper.GetUserAsync("jpmonsalverios.12@gmail.com");
                Category prueba = await _context.Categories.FirstOrDefaultAsync(c => c.Name == "Prueba");          
                ...
                await AddProductAsync(prueba, lorem, "Prueba", 2500000M, new string[] { "Prueba"}, user);
