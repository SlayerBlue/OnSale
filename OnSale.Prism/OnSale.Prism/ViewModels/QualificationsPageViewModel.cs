...
namespace OnSale.Prism.ViewModels
{
    public class QualificationsPageViewModel : ViewModelBase
    {
        ...
        public DelegateCommand AddQualificationCommand => _addQualificationCommand ?? (_addQualificationCommand = new DelegateCommand(AddQualificationCommandAsync));
        ...
        private async void AddQualificationCommandAsync()
        {
            if (Settings.IsLogin)
            {
